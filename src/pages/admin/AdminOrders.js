...
const STATUS_COLORS = {
  ...
  'En preparación': { bg: 'rgba(29, 185, 84,0.15)', fg: '#1DB954', border: 'rgba(29, 185, 84,0.5)' },
...
const styles = {
  ...
  reference: { fontSize: 12, color: '#1DB954' },
  ...
  total: { fontSize: 16, fontWeight: 800, color: '#1DB954' },
};
