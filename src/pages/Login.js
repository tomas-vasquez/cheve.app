...
const styles = {
  container: {
    ...
    padding: 24,
    background:
      'radial-gradient(circle at 25% 15%, rgba(201,162,39,0.12), transparent 45%), ' +
      'radial-gradient(circle at 80% 85%, rgba(255,255,255,0.05), transparent 50%), #000',
    color: '#fff',
  },
  card: {
    width: '100%',
  ...
  label: { fontSize: 13, color: '#cfcfcf', marginBottom: 6 },
  input: {
    marginBottom: 16,
    padding: '12px 14px',
    borderRadius: 10,
  ...
  message: { color: '#7ee787', fontSize: 13, margin: '0 0 12px' },
  submit: {
    backgroundColor: '#c9a227', color: '#000', border: 'none',
    padding: '14px 24px', borderRadius: 10, marginTop: 4,
    cursor: 'pointer', fontWeight: 700, fontSize: 15,
  },
  toggle: {
    marginTop: 16, background: 'none', border: 'none',
    color: '#cfcfcf', fontSize: 13, cursor: 'pointer',
