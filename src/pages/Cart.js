...
const styles = {
  ...
  options: { display: 'block', fontSize: 12, color: '#8a8a8a', marginTop: 2 },
  ...
  subtotal: { flex: 1, textAlign: 'right', color: '#c9a227', fontWeight: 600 },
  empty: { textAlign: 'center', marginTop: 40, marginBottom: 40, color: '#999' },
